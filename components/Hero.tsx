    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="lg:hidden flex flex-col items-center justify-center text-center space-y-6 min-h-[85vh] pt-8">
            ...
            <div className="bg-white/30 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white/40 space-y-6">
              ...
              <div className="space-y-1">
                <h1
                  className="font-display text-4xl sm:text-5xl md:text-6xl font-light text-gray-800 tracking-[0.1em] leading-tight"
                  style={{
              ...
              <div className="text-center">
                <p
                  className="font-cursive text-gray-700 tracking-wide leading-relaxed"
                  style={{ fontSize: "48px" }}
                >
                  Larissa & Alejandro
                </p>
              ...
              <div className="flex flex-col items-center space-y-3 py-4">
                <p className="text-xs text-gray-600 uppercase tracking-[0.3em] font-light">
                  Nosso Grande Dia
                </p>
                <div className="text-center">
                  <p className="font-display text-lg font-light text-gray-700 tracking-wide">
          ...
          <div className="hidden lg:grid lg:grid-cols-12 gap-0 items-center min-h-[70vh]">
            ...
            <div className="lg:col-span-4 text-center space-y-6">
              ...
              <div>
                <h1
                  className="font-display text-5xl xl:text-6xl 2xl:text-7xl font-light text-gray-700 tracking-[0.1em] leading-[0.9] mb-3"
                  style={{
                    fontFamily: "'Playfair Display', serif",
                    fontWeight: 500,
                  }}
                ...
                <h3
                  className="font-display text-5xl xl:text-6xl 2xl:text-7xl font-light text-gray-700 tracking-[0.1em] leading-[0.9]"
                  style={{
                    fontFamily: "'Playfair Display', serif",
                    fontWeight: 500,
                  }}
              ...
              <div className="text-center">
                <p
                  className="font-cursive text-gray-600 tracking-wide leading-relaxed"
                  style={{ fontSize: "48px" }}
                >
                  Larissa & Alejandro
                </p>
            ...
            <div className="lg:col-span-4 flex flex-col items-center justify-center space-y-6 px-6">
              ...
              <div className="text-center space-y-3">
                <p className="text-xs text-gray-500 uppercase tracking-[0.3em] font-light">
                  Nosso Grande Dia
                </p>
                <div className="space-y-1">
                  ...
                  <p className="font-display text-lg font-light text-gray-700 tracking-wider">
                    2026
                  </p>
                </div>
              </div>
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-20 text-center">
        ...
        <div className="hidden lg:flex flex-col items-center space-y-3 animate-pulse">
          <div
            className="w-6 h-10 border-2 rounded-full relative bg-white/30 backdrop-blur-sm shadow-sm"
            style={{ borderColor: "#334870" }}
          >
            <div
              className="w-1 h-3 rounded-full absolute top-2 left-1/2 transform -translate-x-1/2 animate-scroll"
              style={{ backgroundColor: "#334870" }}
            ></div>
          </div>
          <p
            className="text-xs font-light tracking-widest uppercase px-2"
            style={{ color: "#334870" }}
          >
            Role para baixo
          </p>
